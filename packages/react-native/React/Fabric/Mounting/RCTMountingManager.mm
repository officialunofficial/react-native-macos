...
#else // [macOS
    // AppKit resets layer.transform on its next layout pass; the RCTUIView
    // setter stores it so updateLayer re-applies it (and centers the anchor).
    componentView.transform3D = newTransform;
#endif // macOS]
  }
